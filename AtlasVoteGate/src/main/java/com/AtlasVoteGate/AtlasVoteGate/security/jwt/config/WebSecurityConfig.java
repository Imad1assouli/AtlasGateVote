...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/auth/signin", "/auth/signup", "/AtlasVoteGate/**", "/api/admin/electoralparties", "/api/admin/electoralparties/{id}" , "/api/admin/electoralPart","/api/admin/votes/winningParty" ).permitAll()
